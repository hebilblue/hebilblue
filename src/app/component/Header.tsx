...
const Header = () => {
  ...
  return (
    <>
      <header className="flex items-center justify-between p-4 bg-gradient-to-b from-[#08162E] from-8% via-[#08162eb2] to-[#08162E]/0 h-[130px] border-b-1 border-b-[#C9B18B] absolute top-0 z-10 w-[100vw]">
        <Image src={logo} alt="HebilBlue" width={162} height={108} className="md:w-[162px] md:h-[108px] w-[100px] h-[68px]" />
        ...
        <div className="hidden md:flex items-end flex-col gap-[12px]">
          <div className="flex flex-row items-center gap-[12px]">
            ...
            <Link href="/" className="flex flex-row items-center gap-[5px] h-[24px] px-[6px] bg-[#08162E] rounded-[8px]">
      ...
      {/* Mobile Menu Overlay */}
      <div className={`md:hidden fixed inset-0 bg-black bg-opacity-50 z-10 transition-opacity duration-300 ${isMenuOpen ? 'opacity-40' : 'opacity-0 pointer-events-none'}`} onClick={toggleMenu}></div>

      {/* Mobile Menu */}
      <div className={`md:hidden fixed top-0 right-0 h-full w-full sm:w-80 bg-[#08162E] z-20 transform transition-transform duration-300 ease-in-out ${isMenuOpen ? 'translate-x-0' : 'translate-x-full'}`}>
        ...
        <div className="flex flex-col h-full p-4 sm:p-6 pt-16">
          ...
          <div className="mt-auto space-y-3 sm:space-y-4 pt-4">
            ...
            <Link href="/" className="flex flex-row items-center justify-center gap-[6px] sm:gap-[8px] h-[36px] sm:h-[40px] px-[10px] sm:px-[12px] bg-white rounded-[8px] w-full">
              <Image src={pin} alt="pin" width={11} height={16} />
