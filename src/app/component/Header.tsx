...
const Header = () => {
  ...
  return (
    <>
      <header
        className={`sticky flex items-center justify-between p-2 md:p-4 border-b-1 border-b-[#C9B18B] top-0 z-[9999] w-full transition-all duration-300 bg-gradient-to-b from-[#08162E] from-8% via-[#08162eb2] to-[#08162E]/0 backdrop-blur-sm`}
        style={{ WebkitTransform: 'translateZ(0)', position: '-webkit-sticky' }}
      >
